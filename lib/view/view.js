...
export default class View {
  ...
  push (name, value) {
    ...
    if (attr === 'undefined') {
      ...
      throw new Error('You can only push a value to an attribute of type Array')
    }
  ...
  showCriticalError (message) {
    message = message || 'An error has occurred. Please refresh the page and try again.'
    // todo: make layout elements a module
    let el = dom('#flash-error')
    el.html(message).removeClass('hide')
  }
}
